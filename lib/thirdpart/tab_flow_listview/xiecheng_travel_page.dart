...
class _XieChengTravelPage extends State<XieChengTravelPage>
  ...
  void initState() {
    _controller1 =
        TabController(length: 0, vsync: this, initialIndex: currentIndex);
    initData();
    super.initState();
  }
